...
if (LayoutTestUtils.runMode === Bench) {
  if LayoutTestUtils.shouldBenchmarkAllAsOne {
    ...
    let bench_align_items_center () => {
      let root_style = {...LayoutSupport.defaultStyle, alignItems: AlignCenter, width: 10000, height: 10000};
      let root_child0_style = {...LayoutSupport.defaultStyle, width: 1000, height: 1000};
      let root_child0 = LayoutSupport.createNode withChildren::[||] andStyle::root_child0_style ();
      let root = LayoutSupport.createNode withChildren::[|root_child0|] andStyle::root_style ();
      Layout.layoutNode root cssUndefined cssUndefined Ltr;
    ...
    let bench_max_height () => {
      let root_style = {...LayoutSupport.defaultStyle, flexDirection: Row, width: 10000, height: 10000};
      let root_child0_style = {...LayoutSupport.defaultStyle, width: 1000, maxHeight: 5000};
      let root_child0 = LayoutSupport.createNode withChildren::[||] andStyle::root_child0_style ();
      let root = LayoutSupport.createNode withChildren::[|root_child0|] andStyle::root_style ();
      Layout.layoutNode root cssUndefined cssUndefined Ltr;
    ...
    let bench_do_not_clamp_height_of_absolute_node_to_height_of_its_overflow_hidden_parent () => {
      ...
      let root_child0_style = {...LayoutSupport.defaultStyle, positionType: Absolute, start: 0, top: 0};
      let root_child0_child0_style = {...LayoutSupport.defaultStyle, width: 10000, height: 10000};
      let root_child0_child0 =
        LayoutSupport.createNode withChildren::[||] andStyle::root_child0_child0_style ();
      let root_child0 =
    ...
    let bench_wrap_row () => {
      let root_style = {...LayoutSupport.defaultStyle, flexWrap: CssWrap, flexDirection: Row, width: 10000};
      let root_child0_style = {...LayoutSupport.defaultStyle, width: 3000, height: 3000};
      let root_child0 = LayoutSupport.createNode withChildren::[||] andStyle::root_child0_style ();
      let root_child1_style = {...LayoutSupport.defaultStyle, width: 3000, height: 3000};
      let root_child1 = LayoutSupport.createNode withChildren::[||] andStyle::root_child1_style ();
    ...
    let bench_flex_shrink_to_zero () => {
      let root_style = {...LayoutSupport.defaultStyle, height: 7500};
      let root_child0_style = {...LayoutSupport.defaultStyle, width: 5000, height: 5000, flexShrink: 0};
      let root_child0 = LayoutSupport.createNode withChildren::[||] andStyle::root_child0_style ();
      let root_child1_style = {...LayoutSupport.defaultStyle, width: 5000, height: 5000, flexShrink: 1};
      let root_child1 = LayoutSupport.createNode withChildren::[||] andStyle::root_child1_style ();
      let root_child2_style = {...LayoutSupport.defaultStyle, width: 5000, height: 5000, flexShrink: 0};
      let root_child2 = LayoutSupport.createNode withChildren::[||] andStyle::root_child2_style ();
      let root =
        LayoutSupport.createNode
          withChildren::[|root_child0, root_child1, root_child2|] andStyle::root_style ();
    ...
    let bench_flex_basis_overrides_main_size () => {
      let root_style = {...LayoutSupport.defaultStyle, height: 10000, width: 10000};
      let root_child0_style = {...LayoutSupport.defaultStyle, height: 2000, flexGrow: 1, flexBasis: 5000};
      let root_child0 = LayoutSupport.createNode withChildren::[||] andStyle::root_child0_style ();
      let root_child1_style = {...LayoutSupport.defaultStyle, height: 1000, flexGrow: 1};
      let root_child1 = LayoutSupport.createNode withChildren::[||] andStyle::root_child1_style ();
      let root_child2_style = {...LayoutSupport.defaultStyle, height: 1000, flexGrow: 1};
    ...
    (
      fun () => {
        ...
        if (
          ...
          root_child0_child0.layout.width != 10000 || root_child0_child0.layout.height != 2000
        ) {
          assertLayouts
            0
    ...
    (
      fun () => {
        ...
        if (
          ...
          root_child0_child0.layout.top != 0 ||
          root_child0_child0.layout.left != 0 ||
          root_child0_child0.layout.width != 20000 || root_child0_child0.layout.height != 2000
        ) {
          assertLayouts
            4
            ({...root.layout, top: 0, left: 0, width: 20000, height: 10000}, root.layout)
    ...
    (
      fun () => {
        ...
        if (
          ...
          root_child2.layout.width != 5000 || root_child2.layout.height != 5000
        ) {
          assertLayouts
            8
    ...
    (
      fun () => {
        ...
        if (
          ...
          root_child0.layout.top != 2000 ||
          root_child0.layout.left != 0 ||
          root_child0.layout.width != 6000 || root_child0.layout.height != 6000
        ) {
          assertLayouts
            10
  ...
  it
    ...
    (
      fun () => {
        ...
        if (
          root.layout.top != 0 ||
          root.layout.left != 0 || root.layout.width != 4000 || root.layout.height != 4000
        ) {
          assertLayouts 34 ({...root.layout, top: 0, left: 0, width: 4000, height: 4000}, root.layout) []
        };
        Layout.layoutNode root cssUndefined cssUndefined Rtl;
        if (
          root.layout.top != 0 ||
          ...
          assertLayouts 35 ({...root.layout, top: 0, left: 0, width: 4000, height: 4000}, root.layout) []
        }
      }
    );
  it
    ...
    (
      fun () => {
        ...
        if (
          ...
          assertLayouts 36 ({...root.layout, top: 0, left: 0, width: 4000, height: 4000}, root.layout) []
        };
        Layout.layoutNode root cssUndefined cssUndefined Rtl;
        if (
          root.layout.top != 0 ||
          ...
          assertLayouts 37 ({...root.layout, top: 0, left: 0, width: 4000, height: 4000}, root.layout) []
        }
      }
    );
  it
    ...
    (
      fun () => {
        ...
        if (
          ...
          assertLayouts 38 ({...root.layout, top: 0, left: 0, width: 4000, height: 4000}, root.layout) []
        };
        Layout.layoutNode root cssUndefined cssUndefined Rtl;
        if (
          root.layout.top != 0 ||
          ...
          assertLayouts 39 ({...root.layout, top: 0, left: 0, width: 4000, height: 4000}, root.layout) []
        }
      }
    );
  it
    ...
    (
      fun () => {
        ...
        if (
          ...
          assertLayouts 50 ({...root.layout, top: 0, left: 0, width: 2000, height: 2000}, root.layout) []
        };
        Layout.layoutNode root cssUndefined cssUndefined Rtl;
        if (
          root.layout.top != 0 ||
          ...
          assertLayouts 51 ({...root.layout, top: 0, left: 0, width: 2000, height: 2000}, root.layout) []
        }
      }
    );
  it
      ...
      fun () => {
        ...
        if (
          ...
          assertLayouts
            ...
            [
              ({...root_child0.layout, top: 0, left: 0, width: 10000, height: 10000}, root_child0.layout),
              ({...root_child1.layout, top: 10000, left: 0, width: 10000, height: 5000}, root_child1.layout)
            ]
        };
        Layout.layoutNode root cssUndefined cssUndefined Rtl;
        if (
    ...
    (
      fun () => {
        ...
        if (
          ...
          root_child0_child0.layout.top != 0 ||
          root_child0_child0.layout.left != 0 ||
          root_child0_child0.layout.width != 10000 || root_child0_child0.layout.height != 0
        ) {
          assertLayouts
            184
            ({...root.layout, top: 0, left: 0, width: 10000, height: 10000}, root.layout)
