...
if (LayoutTestUtils.runMode === Bench) {
  if LayoutTestUtils.shouldBenchmarkAllAsOne {
    ...
    let bench_bugRepro2 () => {
      ...
      let root_child0_style = {...LayoutSupport.defaultStyle, justifyContent: JustifyFlexStart, width: 2000};
      let root_child0 = LayoutSupport.createNode withChildren::[||] andStyle::root_child0_style ();
      let root_child1_style = {...LayoutSupport.defaultStyle, minHeight: 0, flexDirection: Row, flexGrow: 1};
      let root_child1_child0_style = {...LayoutSupport.defaultStyle, flexGrow: 1};
      let root_child1_child0 =
        LayoutSupport.createNode withChildren::[||] andStyle::root_child1_child0_style ();
      let root_child1 =
    ...
    (
      fun () => {
        ...
        if (
          ...
          root_child1_child0_child0.layout.width != 0 || root_child1_child0_child0.layout.height != 0
        ) {
          assertLayouts
            194
          ...
          assertLayouts
            197
            ({...root_child1_child0.layout, top: 0, left: 0, width: 0, height: 0}, root_child1_child0.layout)
            [
              (
    ...
    (
      fun () => {
        ...
        if (
          ...
          root_child1_child0.layout.top != 0 ||
          root_child1_child0.layout.left != 0 ||
          root_child1_child0.layout.width != 16000 || root_child1_child0.layout.height != 0
        ) {
          assertLayouts
            202
            ({...root.layout, top: 0, left: 0, width: 20000, height: 0}, root.layout)
            [
              ({...root_child0.layout, top: 0, left: 1000, width: 2000, height: 0}, root_child0.layout),
              ({...root_child1.layout, top: 0, left: 3000, width: 16000, height: 0}, root_child1.layout)
            ];
          assertLayouts
            203
            ({...root_child1.layout, top: 0, left: 3000, width: 16000, height: 0}, root_child1.layout)
        ...
        if (
          ...
          assertLayouts
            ...
            ({...root.layout, top: 0, left: 0, width: 20000, height: 0}, root.layout)
            [
              ({...root_child0.layout, top: 0, left: 17000, width: 2000, height: 0}, root_child0.layout),
              ({...root_child1.layout, top: 0, left: 1000, width: 16000, height: 0}, root_child1.layout)
            ];
          assertLayouts
            205
            ({...root_child1.layout, top: 0, left: 1000, width: 16000, height: 0}, root_child1.layout)
